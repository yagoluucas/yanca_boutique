...
export const homeContent: HomePageContent = {
  ...
  hero: {
    ...
    secondaryAction: { label: 'Receber atendimento', href: whatsappHref, external: true },
  },
  benefits: {
    accessibilityLabel: 'Diferenciais da Yanca Boutique',
    items: [
      { title: 'Atendimento próximo', description: 'Converse diretamente com a loja.' },
      { title: 'Curadoria feminina', description: 'Peças escolhidas para diferentes estilos.' },
      { title: 'Compra simples', description: 'Escolha no site e finalize pelo WhatsApp.' },
    ],
  },
  editorial: {
    id: 'novidades',
  ...
  featuredProducts: {
    ...
    items: [
      {
        ...
        category: 'Macacões',
        badge: 'Clássico',
        description: 'Modelagem ajustada, tecido canelado e visual versátil para produções do dia à noite.',
        price: 'R$ 189,90',
      ...
      },
      {
        ...
        category: 'Macacões',
        badge: 'Mais desejado',
        description: 'Um look claro e elegante, com textura suave e caimento que acompanha a silhueta.',
        price: 'R$ 199,90',
      ...
      },
      {
        ...
        category: 'Conjuntos',
        badge: 'Novidade',
        description: 'Top estruturado e saia curta em jeans para um visual jovem, moderno e cheio de personalidade.',
        price: 'R$ 219,90',
    ...
    action: { label: 'Consultar outras peças', href: whatsappHref, external: true },
  },
  collections: {
    id: 'colecoes',
  ...
  about: {
    ...
    action: { label: 'Falar com a Yanca Boutique', href: whatsappHref, external: true },
    highlights: [
      { title: 'Atendimento humanizado', description: 'Você conversa com a loja para confirmar medidas, cores, disponibilidade e entrega.' },
      { title: 'Seleção de peças', description: 'Uma curadoria focada em looks femininos modernos, versáteis e fáceis de usar.' },
      { title: 'Compra sem complicação', description: 'Nada de cadastro ou checkout longo: escolha a peça e continue pelo WhatsApp.' },
    ],
  },
  howItWorks: {
    id: 'como-funciona',
    ...
    steps: [
      { title: 'Escolha sua peça', description: 'Navegue pelos destaques e coleções para encontrar o look que combina com você.' },
      { title: 'Chame pelo WhatsApp', description: 'O botão envia o nome da peça automaticamente para agilizar o atendimento.' },
      { title: 'Confirme os detalhes', description: 'A loja informa tamanhos, cores, pagamento, retirada ou envio disponíveis.' },
    ],
    action: { label: 'Começar atendimento', href: whatsappHref, external: true },
  },
  closingEditorial: {
    id: 'editorial-final',
  ...
  finalCta: {
    ...
    description: 'Fale com a Yanca Boutique para consultar disponibilidade e receber atendimento personalizado.',
    action: { label: 'Conversar no WhatsApp', href: whatsappHref, external: true },
  },
  footer: {
    brand: 'Yanca Boutique',
    monogram: 'YB',
    tagline: 'Moda feminina',
    description: 'Peças selecionadas para mulheres que gostam de se vestir com personalidade.',
